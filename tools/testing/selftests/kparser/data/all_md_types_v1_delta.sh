...
ipcmd parser delete metadata-ruleset name mdl.auto.p0.ipv4_node 
...
#ipcmd parser create node name p0.ether_node min-hdr-length 14 nxt.field-off 12 nxt.field-len 2  nxt.table p0.ether_table md.ruleset mdset.offset
ipcmd parser create node name p0.ipv4_node min-hdr-length 20 hdr.len.field-off 0 hdr.len.field-len 1 hdr.len.mask 0xf hdr.len.multiplier 4 nxt.field-off 9 nxt.field-len 1  nxt.table p0.ip_table md.rule p0.ipv4_node.md.hdr md.rule p0.ipv4_node.md.nhdr md.rule p0.ipv4_node.md.hdrlen md.rule p0.ipv4_node.md.cbyte md.rule p0.ipv4_node.md.hwcbyte md.rule p0.md.tstamp
