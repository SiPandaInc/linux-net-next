...
#IP="sudo /home/jhs/iproute2-p4tc/ip/ip"
IP="$1/ip/ip"
...
ipcmd parser create metadata-rule name md.tcp.proto_parsed	\
...
ipcmd parser create parser name test_parser id 1	\
		metametasize 14						\
		rootnode node.ether
